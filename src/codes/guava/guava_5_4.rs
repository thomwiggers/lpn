...
impl BinaryCode for GuavaCode5_4 {
    fn name(&self) -> String {
        "[5, 4] Guava code".to_owned()
    }
...
mod tests {
    ...
    #[test]
    fn size() {
        let code = GuavaCode5_4.generator_matrix();
    ...
    fn test_generator_representation() {
        ...
        let vector = BinVector::from_bools(&[ true, false, false, false, true ]);
