    ...
    INIT.call_once(|| {
        unsafe {
            let matrix = Box::new(BinMatrix::new(vec![
                BinVector::from_bools(&[true, false, false, true, true]),
                BinVector::from_bools(&[false, true, false, true, true]),
                BinVector::from_bools(&[false, false, true, true, true]),
                
            ]));
            GENERATOR_MATRIX = Box::into_raw(matrix);

            let matrix = Box::new(BinMatrix::new(vec![
                BinVector::from_bools(&[true, true, true, false, true]),
            ...
            map.insert(2, [false, false, false, true, false]); // 2 => (0, 0, 0, 1, 0)
            map.insert(3, [false, false, false, false, true]); // 3 => (0, 0, 0, 0, 1)
